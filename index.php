...
<head>
    ...
    <link href="Logo.svg" rel="icon"
          type="image/x-icon"/>
    <title>Urban Sports Club</title>

    <link href="main.css" rel="stylesheet" type="text/css"/>
    <link href="fontani.css" rel="stylesheet" type="text/css"/>
...
<div id="fullpage">
    ...
    <div class="section">
        ...
        <div id="slogan">
            <div id="one">WE ARE THE BLUE</div>
            <div id="two">THAT BELIEVE IN</div>
            <div id="three">YOU!</div>
        </div>
    </div>

    <div class="section">
        <video data-autoplay data-keepplaying loop muted>
            <source src="Untitled.m4v">
        </video>
        <div id="btn">
            <button data-waves data-waves-background-color="white" data-waves-duration="800"
                    data-waves-hide-duration="1000" data-waves-opacity="0.2"
                    onclick="window.open('Price.html#2','blank');">START TRAINING NOW
            </button>
        </div>
    </div>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="footer-image">
                <img alt="logo" src="Logo2.svg" style="width: 70px;">
            </div>
